...
<% tp.file.move("Compendium/Locations/"+tp.file.title) %>
...
>>>```dataview
list 
where contains(type,"NPC") and  contains(location,"<% tp.file.title %>")
sort file.name asc
>>
...
>>>```dataview
list 
where contains(type,"Quest") and  contains(location," <% tp.file.title %>")
sort file.name asc
>>
...
>>>```dataview
list 
where contains(type,"LoreEvents") and  contains(location,"<% tp.file.title %>")
sort file.name asc
>>
